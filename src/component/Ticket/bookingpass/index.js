...
const PaymentBookingPass = () => {
    ...
    const fetchBookingData = async () => {
      try {
        ...
        const response = await fetch(
          `https://easy-lime-seal-toga.cyclic.app/booking/tickets/${code}`,
          {
            method: "GET",
            headers: {
  ...
  return (
    <div>
      ...
      >
        <h1 className="fw-bold mx-4 py-3">Booking Pass</h1>
        <div className="row bg-light">
          <div className="col-md-7 border rounded bg-white  mt-5">
            <div className=" d-flex ">
              <img
                src={
                  Flight?.ticket.airline.photo ||
                  "../../../../public/img/garuda.png"
                }
                alt="gambar ticket pesawat"
                style={{
                  maxWidth: "40px",
                  height: "60px",
                  objectFit: "cover",
            ...
            <div className="mt-4 row align-items-center">
              ...
              <div
                className="col-md-6 d-flex mt-4 flex-column"
                style={{ marginLeft: "30px" }}
              >
          ...
          {/* =============================== Barcode ================================= */}
          <div
            className="col-md-5 border rounded mt-5"
            style={{
              display: "flex",
